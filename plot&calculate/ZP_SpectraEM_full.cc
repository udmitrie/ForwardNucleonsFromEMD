 ...
 ******************************************************************/
 ...
 //Created by Uliana Dmitrieva (uliana.dmitrieva@cern.ch) on 11/02/2018
    ...
    void ZP_SpectraEM_full()
    {  
		const char* tfName = "results/ZP_SpectraEM_full.txt";
		const char* PlotName = "results/ZP_SpectraEM_full.eps";
...
//______________________________________________________________________		       
	...
	//Fit for ZNC
		fit_hist(hZPC_em, Et, npeaks, nfit, tfName, "ZPC", condition, 0);
...
//______________________________________________________________________     
	...
	//Fit for ZNA
		fit_hist(hZPA_em,  Et, npeaks, nfit, tfName, "ZPA", condition, 0);
