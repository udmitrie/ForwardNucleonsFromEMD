 ...
 ******************************************************************/
 ...
 //Created by Uliana Dmitrieva (uliana.dmitrieva@cern.ch) on 11/02/2018
    ...
    void ZN_Spectra_singleminusmutual()

    {  
		const char* tfName = "results/ZN_SpectraEM_sm.txt";
		const char* PlotName = "results/ZN_SpectraEM_sm.eps";
...
//______________________________________________________________________		       
	...
	//Fit for ZNC
		condition = "no signal in ZNA";
		fit_hist(hZNC_sm, Et, npeaks, nfit, tfName, "ZNC", condition, 0);
...
//______________________________________________________________________     
	...
	//Fit for ZNA
		condition = "no signal in ZNC";
		fit_hist(hZNA_sm,  Et, npeaks, nfit, tfName, "ZNA", condition, 0);
